...
# About TAB
about_label1 = Label(tab5,text="TEAM KRATOS",pady=5,padx=5)
about_label2 = Label(tab5,text="Team Members",pady=5,padx=5)
about_label3 = Label(tab5,text="Dharvi Mittal (E20CSE018)",pady=5,padx=5)
about_label4 = Label(tab5,text="Aditya Sharma (E20CSE033)",pady=5,padx=5)
about_label5 = Label(tab5,text="Aditi Sheemar (E20CSE066)",pady=5,padx=5)
about_label1.grid(column=0,row=1)
about_label2.grid(column=0,row=2)
about_label3.grid(column=0,row=3)
about_label4.grid(column=0,row=4)
about_label5.grid(column=0,row=5)
